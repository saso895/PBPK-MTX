...
with tqdm(range(len(time_points_train))) as ybar:
    ...
    with open('saved_result/mcmc_params0612.pkl', 'rb') as f:
    ...
    baseline = baseline[:10]          # <<< 只保留前 10 个建模参数
    params   = baseline.tolist()      # 转成 list，后面 *params 解包
    # ================================================================
...
save_path =f'saved_result/mcmc_Data0612.pkl' 
