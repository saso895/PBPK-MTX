...
if __name__ == "__main__":
    ...
    az.plot_trace(idata)
    plt.tight_layout()
    plt.savefig("/nfs/home/h18300744/MTXmodel/saved_result/mcmc_traceplot0619.png", dpi=300)
    plt.close()

    # === 8. 保存后验均值 ============
    #os.makedirs('saved_result', exist_ok=True)
    out_path = '/nfs/home/h18300744/MTXmodel/saved_result/mcmc_params0619.pkl'
