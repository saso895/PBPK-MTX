...
# === 5. 采样参数 ===============================================
jit_scale = 0.08        # <-- 初始抖动幅度 (log 空间±5 %)
step_report = 40000
n_iter   = 1000000      # 总迭代
burn_in  = 200000       # 丢弃前 burn_in
...
if __name__ == "__main__":
    ...
    for k, pc in enumerate(post_list, 1):          # post_list 里是 burn-in 后样本
        ...
        draw_path = f"/nfs/home/y18300744/MTXmodel/saved_result/chain{k}_draws0621.pkl"
        ...
        path_k  = f"/nfs/home/y18300744/MTXmodel/saved_result/chain{k}_params0621.pkl"
...
for k in range(step_report, n_iter + 1, step_report):
    ...
    out_xlsx = "/nfs/home/y18300744/MTXmodel/saved_result/mcmc_diag_0621.xlsx"
    ...
    plt.tight_layout()
    plt.savefig("/nfs/home/y18300744/MTXmodel/saved_result/mcmc_traceplot0621.png", dpi=300)
    plt.close()

    # === 8. 保存后验均值 ============
    #os.makedirs('saved_result', exist_ok=True)
    out_path = '/nfs/home/y18300744/MTXmodel/saved_result/mcmc_params0621.pkl'
