...
if __name__ == "__main__":
    ...
    for k, pc in enumerate(post_list, 1):          # post_list 里是 burn-in 后样本
        ...
        path_k  = f"/nfs/home/y18300744/MTXmodel/saved_result/chain{k}_params0620.pkl"
    ...
    az.plot_trace(idata)
    plt.tight_layout()
    plt.savefig("/nfs/home/y18300744/MTXmodel/saved_result/mcmc_traceplot0620.png", dpi=300)
    plt.close()

    # === 8. 保存后验均值 ============
    #os.makedirs('saved_result', exist_ok=True)
    out_path = '/nfs/home/y18300744/MTXmodel/saved_result/mcmc_params0620.pkl'
